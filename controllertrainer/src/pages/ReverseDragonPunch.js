...
import QCFgif from "../images/p2dp.gif";
...
const ControllerTester = () => {
  ...
  useEffect(() => {
    const handleGamepadInput = () => {
      ...
      if (sequenceStep === 0) {
        if (pressedButtons.some((button) => button.button === 14)) {
          setSequenceStep(1);
        }
  ...
  return (
    <div className="gamepad-input-screen">
      ...
      {showGif && (
        <div className="reversezmot-container">
      ...
      {showGif && (
        <div className="kendpreverse-container">
